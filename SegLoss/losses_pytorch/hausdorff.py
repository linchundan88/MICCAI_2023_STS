...
class HausdorffDTLoss(nn.Module):
    ...
    def forward(self, pred: torch.Tensor, target: torch.Tensor, debug=False) -> torch.Tensor: #-> Union[tuple[Any, tuple[Any, Any, Any, Any, Any]], Any]:
        ...
        dt_field = pred_error.to("cuda") * distance.to("cuda")
        loss = dt_field.mean()
