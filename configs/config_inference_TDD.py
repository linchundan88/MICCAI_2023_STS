...
class CFG_inference_TDD:

    threshold = 0.7

    img_suffix = ".JPG"
    img_dirs = f"/disk_data_new/data/Dental/Tufts Dental Database/Radiographs_resized"
    mask_dirs = f"/disk_data_new/data/Dental/Tufts Dental Database/mask_resized/"
    mask_suffix = ".jpg"
    preds_dir = f"/disk_code/code/MICCAI_2023_STS/results/infers/Tufts Dental Database/threshold_{threshold}/"
